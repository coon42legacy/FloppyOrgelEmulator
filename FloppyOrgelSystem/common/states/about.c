...
static void draw() {
  ...
  canvas_drawText(CENTER, 80, "Floppy Orgel v3.0", 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00);
  canvas_drawText(CENTER, 100, "Menu Framework v" VERSION, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00);
  canvas_drawText(CENTER, 140, "coon@c-base.org", 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00);
  display_redraw();
}
